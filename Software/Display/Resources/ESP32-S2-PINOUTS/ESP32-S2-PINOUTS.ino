...
void loop() {
  ...
  testlines(OLED2, RED);
//  testlines(OLED3, BLUE);
/*
  OLED1.fillScreen(RED);
  OLED2.fillScreen(GREEN);
  OLED3.fillScreen(YELLOW);

  testlines(OLED1, YELLOW);
  testlines(OLED2, GREEN);
  testlines(OLED3, RED);
  testlines(OLED4, BLUE);
  testlines(OLED5, WHITE);
  testlines(OLED6, BLACK);

  */
  //testdrawtext("SCREEN ", WHITE);
  //delay(500);
